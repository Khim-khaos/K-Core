...
- **Автоматическая установка ядер:** Поддержка автоматической загрузки и установки Forge, Fabric, NeoForge
- **Зеркала для загрузки:** Автоматическое переключение на зеркала при недоступности основного источника
...
- Purpur
- Magma
- **Forge** (автоустановка через installer)
- **Fabric** (автоустановка серверных файлов)
- **NeoForge** (автоустановка через installer)
