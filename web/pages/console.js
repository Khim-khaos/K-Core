...
consoleCpuUsageBar = new KubekCircleProgress($("#cpu-usage-bar"), 100, circleRadius, "var(--bg-dark-accent)", "var(--bg-dark-accent-light)", "var(--bg-primary-500)");
consoleCpuUsageBar.create();
consoleRamUsageBar = new KubekCircleProgress($("#ram-usage-bar"), 100, circleRadius, "var(--bg-dark-accent)", "var(--bg-dark-accent-light)", "var(--bg-primary-500)");
