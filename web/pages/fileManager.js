    ...
    static refreshDir = (saveScroll = true) => {
        KubekFileManager.readDirectory(currentPath, (data) => {
            ...
            data.forEach((file) => {
                ...
                let dd = String(modifyDateVanilla.getDate()).padStart(2, "0");
                let mm = String(modifyDateVanilla.getMonth() + 1).padStart(2, "0");
                let yyyy = modifyDateVanilla.getFullYear();
                let hh = String(modifyDateVanilla.getHours()).padStart(2, "0");
                let min = String(modifyDateVanilla.getMinutes()).padStart(2, "0");
                let ss = String(modifyDateVanilla.getSeconds()).padStart(2, "0");
                let modifyDate = dd + "." + mm + "." + yyyy + " " + hh + ":" + min + ":" + ss;
