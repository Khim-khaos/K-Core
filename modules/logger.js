...
exports.writeLineToLog = (line) => {
    ...
    fs.appendFile("./logs/" + fileName, line + "\n", (err) => {
        if (err) {
            console.error(pc.red("[LOGGER ERROR] Failed to write to log file:"), err);
        }
    });
};
...
exports.warning = (...args) => {
    ...
    console.log(pc.yellow(preparedText));
    this.writeLineToLog(preparedText);
};
...
exports.error = (...args) => {
    ...
    console.log(pc.red(preparedText));
    this.writeLineToLog(preparedText);
};
...
exports.success = (...args) => {
    ...
    console.log(pc.green(preparedText));
    this.writeLineToLog(preparedText);
};
...
exports.debug = (...args) => {
    ...
    console.log(pc.gray(preparedText));
    this.writeLineToLog(preparedText);
};
...
exports.kubekWelcomeMessage = () => {
    console.log("");
    console.log(pc.cyan(PREDEFINED.KUBEK_LOGO_ASCII));
    console.log("");
    console.log(pc.inverse("Kubek " + packageJSON.version));
    console.log(pc.inverse(packageJSON.repository.url.split("+")[1]));
    console.log("");
}