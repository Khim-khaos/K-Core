...
exports.UPDATES_URL_API = "https://api.github.com/repos/Khim-khaos/K-Core/releases";
...
exports.NO_LOG_URLS = [/\/api\/health/gi, /\/api\/tasks.*/gi, /\/api\/servers.*\/icon.*/gi, /\/api\/servers.*\/query/gi, /\/api\/servers.*\/info/gi, /\/api\/servers.*\/log/gi, "/api/fileManager/chunkWrite/add", "/api/servers", /.*\.woff2/gi, /.*\.js/gi, /.*\.css/gi, /.*\.ttf/gi, /.*\.png/gi, /.*\.ico/gi, "/api/kubek/hardware/usage", "/api/kubek/heartbeat"];
...
exports.SKIP_AUTH_URLS = ["/api/health", "/api/kubek/version", "/api/auth/login", /\/api\/auth\/login\/.*\/.*/gi, /\/login.html/gi, /\/assets\/.*/gi, /\/css\/.*/gi, /\/js\/.*/gi]
